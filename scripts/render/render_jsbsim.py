    ...
    def get_env_fn(rank):
        def init_env():
            if all_args.env_name == "SingleCombat":
                ...
                env = SingleControlEnv(all_args.scenario_name)   #senarion_name: "1/heading"
...
def main(args):
    ...
    # run dir
    #/home/polixir/LAG/scripts/results/JSBSim/simglecombat_vsbaseline/ppo/check
